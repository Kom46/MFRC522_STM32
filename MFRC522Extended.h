...
public:
	...
	MFRC522Extended(GPIO_TypeDef * nRST_Port, uint32_t nRST_Pin) : MFRC522(nRST_Port, nRST_Pin) {};
	MFRC522Extended(GPIO_TypeDef * nCS_Port, uint32_t nCS_Pin ,GPIO_TypeDef * nRST_Port, uint32_t nRST_Pin) : MFRC522(nCS_Port, nCS_Pin, nRST_Port, nRST_Pin) {};
